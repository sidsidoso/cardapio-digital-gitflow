...
Abra `index.html` no navegador para consultar os três produtos. Não é necessário instalar dependências.

Para validar com Node.js 22.13 ou superior: `npm test` e `npm run check`.

O trabalho será organizado em `main`, `develop`, `feature/listar-produtos`, `release/1.0.0` e `hotfix/1.0.1`.
